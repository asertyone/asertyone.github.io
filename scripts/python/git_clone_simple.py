...
REPO_MAP = [
    ...
    ("5mcmj", "spx05/jn.rtcu.sa525m-meta-layers-meta-customizations-meta-jn"),
    ("28mcmj", "spx28/stla.rtcu.sa525m-meta-layers-meta-customizations-meta-jn"),
    ("28ajet", "spx28/stla.rtcu.src-app-jn-ethernet-test"),
    ("28jer", "spx28/stla.rtcu.src-system-jn-extra-rootfs"),
    ("28jcs", "spx28/stla.rtcu.src-service-jn-config-service"),
    ("28mj", "spx28/stla.rtcu.meta-joynext"),
]
